...
const presets = [
  { label: "Hoy", href: "/dashboard?period=today", period: "today" },
  { label: "7 días", href: "/dashboard?period=7d", period: "7d" },
  { label: "30 días", href: "/dashboard?period=30d", period: "30d" },
];

export function DashboardDateFilter({ dateRange }: DashboardDateFilterProps) {
  return (
    <details className="group relative">
      ...
      <div className="absolute right-0 z-40 mt-2 w-[min(22rem,calc(100vw-2rem))] rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_18px_60px_rgba(15,23,42,0.16)]">
        ...
        <form action="/dashboard" className="mt-3 rounded-xl bg-[#f7f8f4] p-3">
