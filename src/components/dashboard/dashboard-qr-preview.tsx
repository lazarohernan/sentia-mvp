  ...
  return (
    ...
    >
      ...
      <QRCodeSVG
        ...
        fgColor="#022c22"
        title={`QR para ${value}`}
        className="h-full w-full rounded-[1.15rem] bg-white p-1 "
      />
      <div
        className="absolute left-1/2 top-1/2 flex h-11 w-24 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl border-emerald-900/10 bg-white px-3 "
        aria-hidden="true"
      >
